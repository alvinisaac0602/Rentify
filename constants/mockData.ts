...
export const MOCK_PROPERTIES: Property[] = [
  ...
  {
    id: 'p4',
    title: 'Budget Hostel Dorm – Nakawa',
    category: 'hostel',
    price: 35000,
    pricePeriod: 'day',
    currency: 'UGX',
    ...
    district: 'Kampala',
    description: 'Clean and social hostel dorm in Nakawa. Perfect for backpackers and budget travellers. Shared kitchen, lounge, and lockers included. 24/7 security.',
    images: UNSPLASH_HOSTEL,
    rating: 4.4,
    reviewCount: 38,
    isVerified: true,
    isFurnished: true,
    ...
    bathrooms: 1,
    size: 30,
    amenities: ['WiFi', 'Lockers', 'Shared Kitchen', 'Lounge', 'Security', 'Laundry'],
    trustScore: 81,
    landlordId: 'l2',
    isAvailable: true,
  ...
  {
    id: 'p5',
    title: 'Private Hostel Room – Entebbe Road',
    category: 'hostel',
    price: 55000,
    pricePeriod: 'day',
    currency: 'UGX',
    ...
    district: 'Kampala',
    description: 'Comfortable private room in a boutique hostel along Entebbe Road. Ideal for solo travellers or couples. Includes breakfast and airport shuttle options.',
    images: [UNSPLASH_HOSTEL[1], UNSPLASH_HOSTEL[2], UNSPLASH_HOSTEL[0]],
    rating: 4.6,
    reviewCount: 21,
    isVerified: true,
    isFurnished: true,
    ...
    bathrooms: 1,
    size: 20,
    amenities: ['WiFi', 'Breakfast', 'Airport Shuttle', 'Lounge', 'Security', 'Air Conditioning'],
    trustScore: 88,
    landlordId: 'l1',
    isAvailable: true,
  ...
  {
    id: 'p6',
    title: 'Backpacker Hostel – Kiwatule',
    category: 'hostel',
    price: 25000,
    pricePeriod: 'day',
    currency: 'UGX',
    ...
    district: 'Kampala',
    description: 'Lively backpacker hostel with a great community vibe. Regular events, rooftop hangout, and flexible stay options. Monthly deals available.',
    images: [UNSPLASH_HOSTEL[2], UNSPLASH_HOSTEL[0], UNSPLASH_HOSTEL[1]],
    rating: 4.2,
    reviewCount: 55,
    isVerified: false,
    isFurnished: true,
    bedrooms: 1,
    bathrooms: 1,
    amenities: ['WiFi', 'Rooftop', 'Events', 'Coffee', 'Lockers'],
    trustScore: 62,
    landlordId: 'l3',
    isAvailable: true,
